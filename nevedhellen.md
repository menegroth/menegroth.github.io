...
I use **boldface** for Sindarin words and phrases interspersed into the text and additionally **_italicize_** examples that are directly attested in Tolkien's writings. A **&dagger;** symbol marks attested forms found only in writings published after Tolkien's death.
...
* [.s lh] is the [.cy ll] sound of Welsh [.cy Lloyd]. Put your tongue in a position to say [.en l] and gently exhale as if pronouncing [.en th].
...
* [.s ph] is as in English [.en phone]. Between vowels, it represents the same sound held for slightly longer, e.g. in [[.s.attested ephel] "outer fence"](^RotK Appendix E, p. 392).
...
* [.s w] can occur at the end of a word: [.s.re têw] "letter", [[.s.att tîw] "letters"](^RotK Appendix E, p. 395), [[.s.post gwaew] "wind"](^LR:444).
* [.s ng] can appear at the beginning of a word: [[.s.attested di-nguruthos] "in the shadow of death"](^LotR, translated in Letters:278 and RGEO:72).
...
Compounds in which each element was a recognizable word (even if affected by mutation) often kept the stress of the individual elements intact. Whichever stress fell on the penultimate or antepenultimate syllable became the primary stress; other stresses were secondary. Thus [.s edhelharn] was [.phonemic "EDElharn], while [.s edhellen] was still [.phonemic E"DEllEn] since the suffix _-len_ could not stand as a word on its own. Stresses of this pattern are seen in hyphenated compounds in classical Sindarin; c.f. [.s.att Gil-galad]. These words are closely enough connected for [.s calad] to lenit to [.s galad], and yet the stress of _galad_ is preserved. In a purely genitive construction "star of light" we might expect _gil calad_; c.f. [[.s.att Ennyn Durin Aran Moria]](^LotR TODO). (note: though Tolkien also wrote [.s.post Ennyn Dhurin Aran Voria], with lenition, in an early draft of the gate inscription. HKF calls this lenition the product of an ["obsolete rule"](^http://folk.uib.no/hnohf/sindarin.htm), which Tolkien seems to have later removed from the language)
