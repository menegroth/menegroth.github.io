# Nevedhellen: A New Sindarin Grammar
...
My aim, however, is different. I hope to present a comprehensive and unified account of *one* variety of Neo-Sindarin&emdash;not because I believe it is in any way authoritative, but to show how it could be done. Readers will no doubt disagree with some of my interpretations on scholarly or aesthetic grounds. I hope this grammar will provide a starting point for their many revisions.
...
I use **bold** for Sindarin words and phrases interspersed into the text and **_bold italics_** for Sindarin words or constructions attested in Tolkien's writings. A **&dagger;** symbol marks attested forms found only in writings published after Tolkien's death.

When discussing a word or phrase that Tolkien did not (as far as we know) actually write, I use the following symbols to indicate why mention of the form is justified:
...
* **?** Marks a speculative translation. There are some words for which Tolkien never provided an explanation&emdash;one of the most notorious is [.s.post aen], found in the King's Letter.
...
Glosses of attested words and phrases are Tolkien's own when he provides one. My own translations are marked with an asterisk.

# Lessons

## Pronunciation

### Sindarin of the Third Age

The vowels [.s a e i o u] are pronounced as in Italian, or as exemplified below:

* [.s a] as in [.en father]
* [.s e] as in [.en let]
* [.s i] as in [.en machine]
* [.s o] as in [.en for]
* [.s u] as in [.en brute]
* [.s y] is close to German [.de ü], or the [.fr u] in French [.fr lune]. Pronounce the [.en i] sound in [.en sit] with your lips rounded as if saying [.en oo].

Vowels marked with an accent ([.s á]) are held slightly longer than unmarked vowels. A circumflex ([.s â]) marks an even longer version of the vowel. Compare the vowel lengths in this greeting:

[.s Elen síla na lû govaded] "A star shines on the hour of meeting"

In addition to the simple vowels Sindarin also has five _diphthongs_, combinations of two vowels pronounced in a single syllable, with a smooth transition from one vowel to the other.

* _ai_ is the sound of _y_ in English _sky_.
* _ae_ has no counterpart in English; it is similar to Sindarin _ai_ but ends with an _e_ sound (as in _let_), instead of an _i_ sound (as in _machine_).
* _au_ has the sound of _ou_ in _house_. At the end of a word it is spelled _aw_: _caw_ "top".
* _ei_ is the sound of _ay_ in English _say_.
* _oe_ has no counterpart in English; it is similar to the _oy_ sound in _boy_, but ends with the same _e_ sound as Sindarin _ae_.
* _ui_ is the sound in English _ruin_.




Consonants _b, d, m, p, t, v, w_ are pronounced more or less as in English and need no further description.

* _c_ is always hard, as in _cat_. _Celeborn_ is pronounced _keleborn_, not _seleborn_.
* _ch_ is close to the raspy sound of Scottish _loch_ or German _Bach_. In Tolkien's own pronunciation, it was more or less like _h_ with the tongue raised slightly toward the back of the mouth as if to pronounce _k_.
* _dh_ is the _th_ sound in _this_.
* _f_ at the end of a word is pronounced _v_, as in English _of_.
* _g_ is likewise always hard, as in _get_; never soft as in _gem_.
* _h_ is pronounced like English _h_, except in the digraphs _th_, _dh_, _ch_, _lh_, _rh_.
* _hw_ is the sound heard in English _whale_, in varieties of English that distinguish it from _wail_.
* _l_ is always the sound in _let_, pronounced with the tip of the tongue touching the upper teeth or just behind them. English has another _l_ sound used at the end of syllables, e.g. _tell_, in which the tongue is bunched up at the back of the mouth and doesn't touch the teeth. This sound does not occur in Sindarin.
* _lh_ is the _ll_ sound of Welsh _Lloyd_. Put your tongue in a position to say _l_ and gently exhale as if pronouncing _th_.
* _n_ is pronounced identically to English _n_. Before _c_, _ch_, _g_, it is pronounced as in _think_ - that is, like the _ng_ sound in _thing_.
* _ng_ at the end of a word is pronounced as in _thing_. Between vowels, it is pronounced as the same sound plus _g_, as in _finger_.
* _ph_ is as in English _phone_. Between vowels, it represents the same sound held for slightly longer, e.g. in _ephel_ "fence".
* _r_ is tapped, as in Spanish, or as in Tolkien's own pronunciation of English. It is never articulated in the back of the throat as in French or German - reportedly the Elves found this sound "distasteful" (RotK:392 Appendix E).
* _th_ is always the sound in _thin_, never the sound in _this_, which is represented in Sindarin by _dh_.
* _rh_ is the _rh_ of Welsh _Rhiannon_. Pronounce a Sindarin _r_, but simultaneously exhale as if pronouncing _h_.

Sindarin has certain sequences of sounds which are not found in English.

* _w_ can occur at the end of a word: **&#42;têw** "letter", **_tîw_** "letters", **&dagger;_gwaew_** "wind".
* _ng_ can appear at the beginning of a word: **_di-nguruthos_** "in the shadow of death" (translated in Letters:278 and RGEO:72).
* Clusters _mr_, _ml_ are possible at the beginning of a word: **am mrôg** "for a bear", **am mlabed** "for flapping"
...
* _ae_ was pronounced [e:] or [ej], according to the Westron dialect of the speaker. (HKF cites Appendix E)
* _ei_ could have been pronounced [@j], to distinguish it from _ae_ and _ai_. HKF notes that Westron "had certain reduction vowels", c.f. RotK Appendix E p. 404, "The new [cirth] 55, 56, were in origin a halved form of 46, and were used for vowels like those heard in the English _butter_, which were frequent in Dwarvish and in the Westron" so a diphthong in [@-] seems a natural choice here.
...
Compounds in which each element was a recognizable word (even if affected by mutation) often kept the stress of the individual elements intact. Whichever stress fell on the penultimate or antepenultimate syllable became the primary stress; other stresses were secondary. Thus _edhelharn_ was ["EDElharn], while _edhellen_ was still [E"DEllEn] since the suffix _-len_ could not stand as a word on its own. Stresses of this pattern are seen in hyphenated compounds in classical Sindarin; c.f. **_Gil-galad_**. These words are closely enough connected for _calad_ to lenit to _galad_, and yet the stress of _galad_ is preserved. In a purely genitive construction "star of light" we might expect _gil calad_; c.f. (**_Ennyn Durin Aran Moria_**). (note: though Tolkien also wrote **_Ennyn Dhurin Aran Voria_**, with lenition, in an early draft of the gate inscription. HKF calls this lenition the product of an "obsolete rule" (http://folk.uib.no/hnohf/sindarin.htm), which Tolkien seems to have later removed from the language)
...
tîw "letters" (RotK:395, Appendix E)
